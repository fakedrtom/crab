...
for i in gene_file:
    ...
    if var_score != 'none' and var_score != 'none':
...
for gene in coords:
    ...
    print("\t".join(coords[gene]) + "\t" + gene + "\t" + str(num_var) + "\t" + ",".join(sorted(var_ids)) + "\t" + str(num_evi) + "\t" + ",".join(sorted(evi_ids)) + "\t" + max_level + "\t" + str(max_rating) + "\t" + ",".join(sorted(evi_types)) + "\t" + ",".join(sorted(evi_dirs)) + "\t" + ",".join(sorted(clin_sigs)) + "\t" + ",".join(sorted(origs)) + "\t" + ",".join(sorted(subtypes)) + "\t" + ",".join(sorted(set(abbr))) + "\t" + str(max_score) + "\t" + str(score_per), file=gene_out)
